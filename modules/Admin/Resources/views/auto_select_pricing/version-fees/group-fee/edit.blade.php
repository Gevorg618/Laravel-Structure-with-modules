        ...
        <div class="col-lg-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    @if($all)
                        <h3 class="panel-title">Viewing Pricing Group Fees <b><i>{{ $group->client->descrip }}</i></b> For All States
                        </h3>
                    @else
                        <h3 class="panel-title">Viewing Pricing Group Fees <b><i>{{ $group->client->descrip }}</i></b> For States <b><i>{{ $state->state }} ({{ $state->abbr }})</i></b>
                        </h3>
                    @endif
                </div>
                <div class="panel-body">
                    ...
                    <div class="container">
                        ...
                        @else
                            {{ Form::open([ 'route' => ['admin.autoselect.pricing.group.fees.update', $group->group_id , $state->abbr ], 'method' => 'put', 
                                    'class' => 'form-group',
                                    'id' => 'form',
...
@push('scripts')
@if($all)
    <script type="text/javascript" src="{{ masset('js/autocomplete-pricing/pricing-group-fee-accordion.js') }}"></script>
@endif
