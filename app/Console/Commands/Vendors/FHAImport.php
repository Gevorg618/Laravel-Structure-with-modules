...
use App\Jobs\Vendors\FHA\Import as FHAImportJob;

class FHAImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'vendors:import-fha-licenses {--state=}';
     ...
     * @var string
     */
    protected $description = 'Import the entire hud.gov appraiser list (or only one state)';
    ...
    public function handle()
    {
        ...
        foreach($statesToRun as $r) {
            ...
            dispatch(new FHAImportJob($r))->onQueue('low');
        }
