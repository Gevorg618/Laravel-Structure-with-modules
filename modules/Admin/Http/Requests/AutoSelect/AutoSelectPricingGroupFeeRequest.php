...
class AutoSelectPricingGroupFeeRequest extends FormRequest
{

    /**
     * Create code in constructor so we can set validation rule
     * AutoSelectPricingGroupFeeRequest constructor.
     *
    ...
    {
        return [
            'group_id'  => 'required|unique:autoselect_pricing_group_fees,group_id,NULL,id,deleted_at,NULL'
        ];
    }
    ...
    {
       return [
            // 'group_id'  => 'required|unique:autoselect_pricing_group_fees,group_id,'.$this->route('id').',group_id'
        ];
    }
