<template>
  <div class="row">
    ...
    <div class="col-md-6 col-sm-12 mrg-btm-15">
      <b-dropdown v-model="type" class="full-width-dropdown">
        <button slot="trigger" class="button">
          <span>{{ typeTitle }}</span>
          <b-icon icon="caret-down"/>
        </button>

        <b-dropdown-item value="internal">Internal</b-dropdown-item>
        <b-dropdown-item value="external">External</b-dropdown-item>
      </b-dropdown>
...
<script>
import Notification from "@/components/docuvault/notification/description";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: "schd_date", title: "Inspection Date" },
