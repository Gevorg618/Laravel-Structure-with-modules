...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
      <tr>
        <td align="center" valign="middle" bgcolor="#FFFFFF"><img editable="true" mc:edit="nm10-05" src="https://maps.googleapis.com/maps/api/staticmap?center={{ urlencode($order->address) }}&zoom=13&size=600x350&maptype=roadmap&markers=color:blue%7Clabel:S%7C{{ urlencode($order->address) }}&key={{ config('services.google.maps.key') }}" width="600" height="350" alt="" style="display:block;width:100% !important; height:auto !important; " /></td>
      </tr>
    </table></td>
  </tr>
</table>
