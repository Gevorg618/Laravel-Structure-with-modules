...
{!! Form::open(['route' => 'admin.reports.generator.create.task', 'id' => 'form-rcreate-task',  'enctype' => "multipart/form-data"]) !!}
    ...
    <div class="form-group col-md-6">
        ...
        <div class="col-lg-12 col-xs-12">
            {!! Form::textarea('emails', null, ['class' => 'form-control', 'data-role' => "tagsinput", 'placeholder' => 'Enter one email address per line']) !!}
        </div>                                        
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('daterange', ['day' => 'Current Day',  'week' => 'Current Week',  'month' => 'Current Month'], null, ['class' => 'form-control']) }}
        </div>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <div class="col-lg-12 col-xs-12">
            {!! Form::text('date_range_num', null, ['class' => 'form-control']) !!}
        </div>                                       
    </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('minutes', $m, null, ['class' => 'form-control', 'id' => 'minutes']) }}
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('hours', $h, null, ['class' => 'form-control', 'id' => 'hours']) }}
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('weekday', $w, null, ['class' => 'form-control', 'id' => 'weekday']) }}
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('monthday', $mD, null, ['class' => 'form-control', 'id' => 'monthday']) }}
        </div>
    </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-lg-12 col-xs-12">
            {{ Form::select('weekends', ['1' => 'Yes', '0' => 'No'], null, ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="form-group col-md-6">
    ...
    <div style="display:none;">
        <textarea name='task_data' id="task_data">{{serialize($data)}}</textarea>
    </div>
