<form id="add_event_form" class="form-horizontal" role="form">
    <input type='hidden' name='form_event_id' id='form_event_id' value=""/>
    <div class="row">
        <div class="col-md-11">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="event_start_date" readonly="readonly"
                            ...
                            <div class="col-md-9">
                                <select name="event_calendar_id" id="event_calendar_id" class="form-control">
                                    ...
                                    @foreach($calendarData as $calendar)
                                        <option value="{{$calendar['key']}}">{{$calendar['title']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
